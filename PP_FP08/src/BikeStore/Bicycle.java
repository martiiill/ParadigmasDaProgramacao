...
public class Bicycle {
    ...
    public String toString() {
        return "Bicycle{" + "id=" + id + ", numberOfGears=" + numberOfGears +
                ", mainColor=" + mainColor + ", wheelsize=" + wheelsize + 
                ", bikeLenght=" + bikeLenght + ", adjustableSeatpost=" + 
                adjustableSeatpost + ", price=" + price + '}';
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.numberOfGears != other.numberOfGears) {
            return false;
        }
        if (!Objects.equals(this.mainColor, other.mainColor)) {
            return false;
        }
        if (Float.floatToIntBits(this.wheelsize) != Float.floatToIntBits(other.wheelsize)) {
            return false;
        }
        if (Float.floatToIntBits(this.bikeLenght) != Float.floatToIntBits(other.bikeLenght)) {
            return false;
        }
        if (this.adjustableSeatpost != other.adjustableSeatpost) {
            return false;
        }
        return Float.floatToIntBits(this.price) == Float.floatToIntBits(other.price);
    }
}
