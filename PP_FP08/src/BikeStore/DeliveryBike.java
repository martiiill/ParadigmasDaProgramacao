...
import ObjectManagement.SponsorsManagement;
...
public class DeliveryBike extends Bicycle {
    ...
    private SponsorsManagement[] sponsors_management;
    ...
    public SponsorsManagement[] getSponsors_management() {
        return sponsors_management;
    }

    public void setSponsors_management(SponsorsManagement[] sponsors_management) {
        this.sponsors_management = sponsors_management;
    }
    ...
    public String toString() {
        return "DeliveryBike{" + "SPONSOR_SIZE=" + SPONSOR_SIZE + ", basketCapacity=" + basketCapacity + ", isFrontBasket=" + isFrontBasket + ", sponsors=" + Arrays.toString(sponsors) + ", numberOfSponsors=" + numberOfSponsors + ", sponsors_management=" + Arrays.toString(sponsors_management) + '}';
    }  
}
