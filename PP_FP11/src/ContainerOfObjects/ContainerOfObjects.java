package ContainerOfObjects;

import Exceptions.EmptyArrayException;
import Exceptions.NotAnInstanceOfComparableException;
import JaFui.Evento;
...
public class ContainerOfObjects {
    ...
    /**
     * Método que permite ordenar
     *
     * @throws Exceptions.EmptyArrayException
     * @throws Exceptions.NotAnInstanceOfComparableException
     */
    public void sort() throws EmptyArrayException, NotAnInstanceOfComparableException {
        if (numberOfObjects == 0) {
            throw new EmptyArrayException("O array está super vazio, não tem elementos.");
        } else {
            if (objects[0] instanceof Evento) {
                Arrays.sort(objects);
            } else {
                throw new NotAnInstanceOfComparableException("Nao é uma instancia comparavel.");
            }
        }
    }
